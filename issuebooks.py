...
def issue():
    ...
    try:
        cur.execute("insert into books_issued(bid,issuedto)values(""+bid+"",""+issueto+"")")
        con.commit()
...
def issueBook():
   ...
   lFrame=Frame=Frame(root,bg="black")
   ...
   lb2=Label(lFrame,text="Issued to ",bg="black",fg="white",font=('Courier',14))
