...
def View():
    ...
    e1=Label(lFrame,width=35,text="Book ID",borderwidth=2,relief='ridge',anchor="w",bg="gray",fg="white")
    e1.grid(row=0,column=0)
    e2=Label(lFrame,width=35,text="Title",borderwidth=2,relief='ridge',anchor="w",bg="gray",fg="white")
    e2.grid(row=0,column=1)
    e3=Label(lFrame,width=35,text="Author",borderwidth=2,relief='ridge',anchor="w",bg="gray",fg="white")
    e3.grid(row=0,column=2)
    e4=Label(lFrame,width=35,text="Status",borderwidth=2,relief='ridge',anchor="w",bg="gray",fg="white")
    ...
    quitBtn.place(x=650,y=560,width=80,height=40)
    root.mainloop()
